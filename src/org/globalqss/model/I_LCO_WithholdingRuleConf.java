...
public interface I_LCO_WithholdingRuleConf 
{
	...
	/*
	 * Included by vcappugi 
	 * update venezuelan withholding
	 */
	
	//TxIDType Bussines partner
	/** Column name IsUseTxIDType */
    public static final String COLUMNNAME_IsUseTxIDType = "IsUseTxIDType";

	/** Set Is Use tx ID Type Bussiness Partner	  */
	public void setIsUseTxIDType (boolean IsUseTxIDType);

	/** Get Is Use Tx ID Type Bussines Partner  */
	public boolean isUseTxIDType();
	
	//Municipality bussines partner
	...
	/** Get Is Use Municipality  */
	public boolean isUseMunicipality();
	
	//Product CIUU
	
	/** Column name IsUseProoduct_CIU */
	...
	//use amount od document
		/** Column name IsUseTxIDType */
	    public static final String COLUMNNAME_IsUseAmount = "IsUseAmount";

		/** Set Is Use Amount of document */
		public void setIsUseAmount (boolean IsUseAmount);
