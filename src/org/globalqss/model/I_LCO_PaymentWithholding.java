...
public interface I_LCO_PaymentWithholding 
{
    ...
    /** Column name IsRecalcInPayment */
    public static final String COLUMNNAME_IsRecalcInPayment = "IsRecalcInPayment";
    ...
    /** Column name LCO_PaymentWithholding_UU */
    public static final String COLUMNNAME_LCO_PaymentWithholding_UU = "LCO_PaymentWithholding_UU";
	...
	/** Column name C_Payment_Relationed_ID */
    public static final String COLUMNNAME_C_Payment_Relationed_ID = "C_Payment_Relationed_ID";

	/** Set C_Payment_Relationed_ID.
	  * Payment identifier
	  */
	public void setC_Payment_Relationed_ID (int C_Payment_Relationed_ID);

	/** Get C_Payment_Relationed_ID.
	  * Payment identifier
	  */
