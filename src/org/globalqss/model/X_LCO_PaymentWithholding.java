...
@org.adempiere.base.Model(table="LCO_PaymentWithholding")
...
// N
    ...
    /** Standard Constructor */
    public X_LCO_PaymentWithholding (Properties ctx, int LCO_PaymentWithholding_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LCO_PaymentWithholding_ID, trxName, virtualColumns);
      /** if (LCO_PaymentWithholding_ID == 0)
        {
			setC_Payment_ID (0);
			setIsCalcOnPayment (false);
...
// N
    ...
    /** Standard Constructor */
    public X_LCO_PaymentWithholding (Properties ctx, String LCO_PaymentWithholding_UU, String trxName)
    {
      super (ctx, LCO_PaymentWithholding_UU, trxName);
      /** if (LCO_PaymentWithholding_UU == null)
        {
			setC_Payment_ID (0);
			setIsCalcOnPayment (false);
// N
...
// N
    ...
    /** Standard Constructor */
    public X_LCO_PaymentWithholding (Properties ctx, String LCO_PaymentWithholding_UU, String trxName, String ... virtualColumns)
    {
      super (ctx, LCO_PaymentWithholding_UU, trxName, virtualColumns);
      /** if (LCO_PaymentWithholding_UU == null)
        {
			setC_Payment_ID (0);
			setIsCalcOnPayment (false);
...
// N
    ...
    {
      StringBuilder sb = new StringBuilder ("X_LCO_PaymentWithholding[")
	...
	*/
	...
	/** Set IsRecalcInPayment.
		@param IsRecalcInPayment IsRecalcInPayment
	*/
	public void setIsRecalcInPayment (boolean IsRecalcInPayment)
	{
		set_Value (COLUMNNAME_IsRecalcInPayment, Boolean.valueOf(IsRecalcInPayment));
	}

	/** Get IsRecalcInPayment.
		@return IsRecalcInPayment	  */
	public boolean isRecalcInPayment()
	{
		Object oo = get_Value(COLUMNNAME_IsRecalcInPayment);
		if (oo != null)
		{
			 if (oo instanceof Boolean)
				 return ((Boolean)oo).booleanValue();
	...
	*/
	...
	/** Set LCO_PaymentWithholding.
		@param LCO_PaymentWithholding_ID LCO_PaymentWithholding
	*/
	...
	/** Get LCO_PaymentWithholding.
		@return LCO_PaymentWithholding	  */
	...
	/** Set LCO_PaymentWithholding_UU.
		@param LCO_PaymentWithholding_UU LCO_PaymentWithholding_UU
	*/
	public void setLCO_PaymentWithholding_UU (String LCO_PaymentWithholding_UU)
	{
		set_Value (COLUMNNAME_LCO_PaymentWithholding_UU, LCO_PaymentWithholding_UU);
	}

	/** Get LCO_PaymentWithholding_UU.
		@return LCO_PaymentWithholding_UU	  */
	public String getLCO_PaymentWithholding_UU()
	{
		return (String)get_Value(COLUMNNAME_LCO_PaymentWithholding_UU);
	}

	public org.globalqss.model.I_LCO_WithholdingRule getLCO_WithholdingRule() throws RuntimeException
	{
		return (org.globalqss.model.I_LCO_WithholdingRule)MTable.get(getCtx(), org.globalqss.model.I_LCO_WithholdingRule.Table_ID)
	...
	*/
	...
	@Override
	public void setC_Payment_Relationed_ID(int C_Payment_Relationed_ID) {
		if (C_Payment_Relationed_ID < 1)
			set_ValueNoCheck (COLUMNNAME_C_Payment_Relationed_ID, null);
		else
			set_ValueNoCheck (COLUMNNAME_C_Payment_Relationed_ID, Integer.valueOf(C_Payment_Relationed_ID));
		
	}

	@Override
	public int getC_Payment_Relationed_ID() {
		Integer ii = (Integer)get_Value(COLUMNNAME_C_Payment_Relationed_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
