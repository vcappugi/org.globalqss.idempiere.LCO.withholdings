...
public interface I_LCO_WithholdingRule 
{
	...
	/* Update from withholdin venezuela
	 * by vcappugi
	 */
	/** Column name IsUseTxIDType */
    public static final String COLUMNNAME_IsUseTxIDType = "IsUseTxIDType";
    /** Set and get IsUseTxIDType	  */
	public void setIsUseTxIDType (boolean IsUseTxIDType);
	public boolean isUseTxIDType();
	
	/**taxidtype */
	/** Column name LCO_TaxIDType*/
	...
	/** Columnamo IsUseProductCIU */
	public static final String COLUMNNAME_IsUseProduct_CIU = "IsUseProduct_CIU";
    /** Set and get IsUseTxIDType	  */
	public void setIsUseProduct_CIU (boolean IsUseProduct_CIU);
	public boolean isUseProduct_CIU();
	
	/**Product CIUU */
	/** Column name LCO_Product_ISIC_ID*/
    public static final String COLUMNNAME_LCO_Product_ISIC_ID = "LCO_Product_ISIC_ID";

	/** Set Municipality	  */
	public void setLCO_Product_ISIC_ID (int LCO_Product_ISIC_ID);

	/** Get Municipality	  */
	public int getLCO_Product_ISIC_ID();
	
	
	
	
    
    //queda poner los set y get de IsuseTxIDType, IsUseMunicipality, IsUseProduct_CIU y los campos
    // LCO_TaxIDType, C_Municipality (que no tiene modelo) y LCO_Product_ISIC_ID
    //Hacrlo ahorita que ahora es que falta
