...
////*******///////	
	...
	public void setIsUseTxIDType(boolean IsUseTxIDType) {
		throw new IllegalArgumentException ("IsUseTxIDType is virtual column");
		
	}
	
	@Override
	public boolean isUseTxIDType() {
		Object oo = get_Value(COLUMNNAME_IsUseTxIDType);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public void setIsUseMunicipality(boolean IsUseMunicipality) {
		throw new IllegalArgumentException ("IsUseMunicipality is virtual column");
	...
	public void setIsUseProduct_CIU(boolean IsUseProduct_CIU) {
		throw new IllegalArgumentException ("IsUseProduct_CIUU is virtual column");
		
	}

	@Override
	public boolean isUseProduct_CIU() {
		Object oo = get_Value(COLUMNNAME_IsUseProduct_CIU);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public void setLCO_Product_ISIC_ID(int LCO_Product_ISIC_ID) {
		if (LCO_Product_ISIC_ID < 1) 
			set_Value (COLUMNNAME_LCO_Product_ISIC_ID, null);
		else 
			set_Value (COLUMNNAME_LCO_Product_ISIC_ID, Integer.valueOf(LCO_Product_ISIC_ID));
		
	}

	@Override
	public int getLCO_Product_ISIC_ID() {
		Integer ii = (Integer)get_Value(COLUMNNAME_LCO_Product_ISIC_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
