...
public class X_LCO_WithholdingRuleConf extends PO implements I_LCO_WithholdingRuleConf, I_Persistent 
{
	...
	public void setIsUseTxIDType(boolean IsUseTxIDType) {
		set_Value (COLUMNNAME_IsUseTxIDType, Boolean.valueOf(IsUseTxIDType));
	...
	public void setIsUseProduct_CIU(boolean IsUseProduct_CIU) {
		set_Value (COLUMNNAME_IsUseProduct_CIU, Boolean.valueOf(IsUseProduct_CIU));
	...
	{
		set_Value (COLUMNNAME_IsUseAmount, Boolean.valueOf(IsUseAmount));
	}
...
{
	Object oo = get_Value(COLUMNNAME_IsUseAmount);
	if (oo != null) 
	{
		 if (oo instanceof Boolean) 
			 return ((Boolean)oo).booleanValue(); 
