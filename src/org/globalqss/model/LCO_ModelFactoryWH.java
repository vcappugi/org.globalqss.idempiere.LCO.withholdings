...
public class LCO_ModelFactoryWH implements IModelFactory {
	...
	public Class<?> getClass(String tableName) {
		...
		if (X_LCO_WithholdingReceipt.Table_Name.equals(tableName))
			return X_LCO_WithholdingReceipt.class;
		if (X_LCO_PaymentWithholding.Table_Name.equals(tableName))
			return X_LCO_PaymentWithholding.class;
		return null;
	}
	...
	public PO getPO(String tableName, int Record_ID, String trxName) {
		...
		if (X_LCO_WithholdingReceipt.Table_Name.equals(tableName))
			return new X_LCO_WithholdingReceipt(Env.getCtx(), Record_ID, trxName);
		if (X_LCO_PaymentWithholding.Table_Name.equals(tableName))
			return new X_LCO_PaymentWithholding(Env.getCtx(), Record_ID, trxName);
		return null;
	}
	...
	public PO getPO(String tableName, ResultSet rs, String trxName) {
		...
		if (X_LCO_WithholdingReceipt.Table_Name.equals(tableName))
			return new X_LCO_WithholdingReceipt(Env.getCtx(), rs, trxName);
		if (X_LCO_PaymentWithholding.Table_Name.equals(tableName))
			return new X_LCO_PaymentWithholding(Env.getCtx(), rs, trxName);
		return null;
	}
